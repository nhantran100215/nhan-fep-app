...
const LoginPage = () => {
  ...
  return (
    <div className="bg-[url('../image/login-bg.jpg')] bg-cover font-sans flex justify-center min-h-screen">
      <div className="wrap mobWF:wrap-mobWF deskWF:wrap-deskWF">
        {/* introduce */}
        ...
        <div className="introduce tabWF:introduce-tabWF">
          ...
          <div className="flex flex-col z-10 tabWF:items-center">
            ...
            <div className="text-login_page-text-blur">
              <span className="tabWF:text-center">
            ...
            <div>
              ...
              <Form.Item className="mt-3 ">
                <Checkbox className="flex  items-center">
                  <span className="font-light font-poppins_regular ml-3">
              ...
              <Form.Item className="mt-3 ">
                <div className="font-normal text-base ">
                  <p className="inline text-login_page-grey">
                    Don't have an account?
                  </p>
                  <a href="#" className="text-login_page-blue ">
                    Sign up
                  </a>
                </div>
              </Form.Item>
